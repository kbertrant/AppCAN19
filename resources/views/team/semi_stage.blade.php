...
@section('title', ' - Semi Final Stage')
...
<section class="wrapper">
        <div class="row mt">
            <div class="col-lg-offset-2 col-lg-6 col-md-6 col-sm-12 centered">
                <div class="showback">
                    <h2>SEMI FINALS STAGE</h2>
                    <h6 class="center">Here are the teams for the semi final match<br></h6>
                    ...
                    <br>
                    <a class="btn btn-theme btn-block" href="{{ route('team.semi_crossing') }}">
                        {{ __('NEXT') }}
                    </a>
                </div>
            </div>
