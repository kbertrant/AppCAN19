                ...
                <div class="showback">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
							<img src="{{ asset($countries[$team_name_pro2[0]->TEAM_NAME]['IMG'])}}" alt="Team flag" style="width:130px; height:130px; border-radius:80px; border:1px solid;">
							<br><h3>{{ $countries[$team_name_pro2[0]->TEAM_NAME]['NAME'] }}</h3>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
							<img src="{{ asset($countries[$team_away_pro2[0]->TEAM_NAME]['IMG'])}}" alt="Team flag" style="width:130px; height:130px; border-radius:80px; border:1px solid;">
							<br><h3>{{ $countries[$team_away_pro2[0]->TEAM_NAME]['NAME'] }}</h3>
                        </div>
                        <h5 class="h4_match">SECOND HALF</h5>
				 	...
				 	<table class="table table-striped">
						<tbody>
							...
							<tr>
                                <td><h6><span class="pull-left">{{$injuries_pro1}}</span> INJURIES <span class="pull-right">{{$injuries_pro2}}</span></h6></td>
							</tr>
						</tbody>
				 	</table>
                    <br>
...
@section('scripts')
	...
	<script type="text/javascript">
		function countdown() {
    		...
    		if (parseInt(i.innerHTML) === 5) {      // update here add minutes match
				document.getElementById("timer").innerHTML= "Additional time";
        		location.href = "{{  route('match.match_end') }}";
    		}
