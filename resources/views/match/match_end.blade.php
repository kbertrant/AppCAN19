                ...
                <div class="showback">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                            <img src="{{ asset($countries[$team_name_end[0]->TEAM_NAME]['IMG'])}}" alt="Team flag" style="width:130px; height:130px; border-radius:80px; border:1px solid;">
                            <br><h3>{{ $countries[$team_name_end[0]->TEAM_NAME]['NAME'] }}</h3>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                            <img src="{{ asset($countries[$team_away_end[0]->TEAM_NAME]['IMG'])}}" alt="Team flag" style="width:130px; height:130px; border-radius:80px; border:1px solid;">
                            <br><h3>{{ $countries[$team_away_end[0]->TEAM_NAME]['NAME'] }}</h3>
                        </div>
                        <h5 class="h4_match">FINAL WHISTLE</h5>
                    ...
                    <table class="table table-striped">
                        <tbody>
                                ...
                                <td>
                                    <div class="">
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" style="padding:0px;">
                                            <h6><span class="pull-left">{{$but_home}}</span></h6>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 centered" style="padding:0px;">
                                            <h6><span>GOALS</span></h6>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" style="padding:0px;">
                                            <h6><span class="pull-right">{{$but_away}}</span></h6>
                                        </div>
                                    </div>
                                    <div class="">
                                        @if(!empty($players_1) && count($players_1) > 0)
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                                        ...
                                        @endif
                                        @if(!empty($players_2) && count($players_2) > 0)
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding:0px; float:right;">
                                                <span class="pull-right">
                                                    @for($i = 0; $i < count($cards_2); $i++)
                                                        @if ($isViewed_2[$i] <= 65)
                                                            @if ($red_cards_2[$i] == 0)
                                                                <img src="{{asset('img/yellow_card_1.jpeg')}}" alt="img" style="height:15px; width:10px; float:left;">&nbsp;{{$cards_time_2[$i]}}' - {{$cards_2[$i]}} <br>
                                                            @else
                                                                <img src="{{asset('img/red_card_1.jpeg')}}" alt="img" style="height:15px; width:10px; float:left;">&nbsp;{{$cards_time_2[$i]}}' - {{$cards_2[$i]}} <br>
                                                            @endif
                                                        @endif
                                                    @endfor
                                                </span>
                            ...
                            <tr>
                                <td><h6><span class="pull-left">{{$injuries_end1}}</span> INJURIES <span class="pull-right">{{$injuries_end2}}</span></h6></td>
                            </tr>
                        </tbody>
                    </table>
                    <br>
